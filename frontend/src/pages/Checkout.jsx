...
//                         <option>India</option>
//                       </select>
//                       <div className="invalid-feedback">Select a valid country.</div>
//                     </div>
//                     <div className="col-md-4 my-1">
...
//                       <div className="invalid-feedback">Card name required.</div>
//                     </div>
//                     <div className="col-md-6">
//                       <label htmlFor="cc-number" className="form-label">Credit card number</label>
//                       <input type="text" className="form-control" id="cc-number" required />
//                       <div className="invalid-feedback">Card number required.</div>
//                     </div>
//                     <div className="col-md-3">
